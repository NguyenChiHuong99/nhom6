@extends('layout')
@section('title','welcom to register')
			...
			<div class="col-lg-6">
				<div class="login_box_img">
					<div class="hover">
						...
						<a class="button button-account" href="{{route('loginUser')}}">Đăng nhập</a>
					</div>
				</div>
			</div>
			<div class="col-lg-6">
				<div class="login_form_inner register_form_inner">
					<h3 class="text-center">Tạo tài khoản của bạn</h3>
					<form class="row login_form" action="{{route('register')}}" method="post" id="register_form">
						...
						<div class="col-md-12 form-group">
							<input type="text" class="form-control" id="email" name="email" value="{{old('email')}}" placeholder="Email Address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email Address'">
							@if ($errors->has('email'))
